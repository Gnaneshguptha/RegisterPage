...
public class nc5mobile {
public static void nc5mobile() {

	//mobile->gmail
	//nested swicth1.22
		Scanner sc=new Scanner(System.in);
		System.out.println("Enter (1)->>Gender (2)->>DOB");
		System.out.println("      (3)->>username  (4)->>Address");
		...
		if(nc2=='1')
		{
			...
			case '1':
				...
				System.out.println("2->>username 3->>Address");
				...
				if(nc3=='1')
				{
					...
					case '1':
						maindob.dobs();
						//nestds 1.24
						System.out.println("1->>username  2->>Address");
		...
		if(nc2=='2')
		{
			...
			case '2':
				maindob.dobs();
				System.out.println("1->Gender 2->username 3->Address");
				...
				case '3'://///////////
					mainaddress.madd();
					System.out.println("1->Gender 2->username");
		...
		if(nc2=='4')
		{
			...
			case '4':////////////////////
				mainaddress.madd();
					System.out.println("Enter 1->>DOB");
					System.out.println("2->>Gender  3->>username");
					char nc3 = sc.nextLine().charAt(0);
					if(nc3=='1')
					{
						switch (nc3) {
