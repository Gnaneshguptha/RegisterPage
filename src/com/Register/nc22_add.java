...
public class nc22_add {
public static void nc22_ads() {
	...
	if(nc2=='2')
	{
		...
		case '2':
			maindob.dobs();
			System.out.println("1->username 2->Mobile_no 3->Gender");
			...
			case '2':
				mainmobile.mbn();
				System.out.println("1->username 2->Gender");
	...
	if(nc2=='3')
	{
		...
		case '3':
			mainmobile.mbn();
			System.out.println("Enter 1->>DOB");
			System.out.println("2->>username 3->>Gender");
			char nc3 = sc.nextLine().charAt(0);
			if(nc3=='1')
			{
				switch (nc3) {
