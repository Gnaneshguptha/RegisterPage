...
import java.util.*;
public class nc1_address {
	//add->password
	public static void nc1_add() {
		...
		if(nc2=='2')
		{
			...
			case '2':
				maindob.dobs();
				System.out.println("1->Gender 2->Mobile_no 3->Password");
				...
				case '3'://///////////
					mainpassword.mps();
					maincpass.cpass();
					System.out.println("1->Gender 2->Mobile");
		...
		if(nc2=='4')
		{
			...
			case '4':////////////////////
				...
				maincpass.cpass();
					System.out.println("Enter 1->>DOB");
					System.out.println("2->>Gender  3->>Mobile");
					char nc3 = sc.nextLine().charAt(0);
					if(nc3=='1')
					{
						switch (nc3) {
		...
		if(nc2=='3')
		{
			...
			case '3'://main 3///////////////
				mainmobile.mbn();
				System.out.println("Enter 1->>DOB");
				System.out.println("2->>Gender  3->>Password");
				char nc3 = sc.nextLine().charAt(0);
				if(nc3=='1')
				{
					switch (nc3) {
					case '1':
						maindob.dobs();
						//nestds 1.24
						System.out.println("1->>Gender  2->>Password");
						char nc4 = sc.nextLine().charAt(0);
						if(nc4=='1')
						{
							switch (nc4) {
