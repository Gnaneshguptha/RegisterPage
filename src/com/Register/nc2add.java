...
public static void nc2adds() {
	...
	if(nc2=='2')
	{
		...
		case '2':
			maindob.dobs();
			System.out.println("1->Gmail 2->Mobile_no 3->Gender");
			...
			case '2':
				mainmobile.mbn();
				System.out.println("1->Gmail 2->Gender");
			...
			case '3'://///////////
				maingender.gen();
				System.out.println("1->Gmail 2->Mobile");
	...
	if(nc2=='4')
	{
		...
		case '4':////////////////////
			maingender.gen();
				System.out.println("Enter 1->>DOB");
				System.out.println("2->>Gmail  3->>Mobile");
				char nc3 = sc.nextLine().charAt(0);
				if(nc3=='1')
				{
					switch (nc3) {
	...
	if(nc2=='3')
	{
		...
		case '3':
			mainmobile.mbn();
			System.out.println("Enter 1->>DOB");
			System.out.println("2->>Gmail 3->>Gender");
			char nc3 = sc.nextLine().charAt(0);
			if(nc3=='1')
			{
				switch (nc3) {
